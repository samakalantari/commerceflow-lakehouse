...
with DAG(
    dag_id=DAG_ID,
    description=("Behavioral Bronze-to-Silver ETL using event time"),
    ...
    load_fact_behavioral_event = SparkSubmitOperator(
        task_id=("load_fact_behavioral_event"),
        conn_id=SPARK_CONN_ID,
        application=("/opt/project/spark_apps/silver/jobs/load_fact_behavioral_event.py"),
        packages=(SPARK_PACKAGES),
        conf=(COMMON_SPARK_CONF),
        env_vars=(DRIVER_ENV_VARS),
        name=("behavioral-silver-event-time-etl"),
        deploy_mode=("client"),
        verbose=False,
